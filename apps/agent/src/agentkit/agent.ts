...
const prompt =
  ...
  'If there is not an ongoing game (state is "empty" or "settled"), create a new one. The title should be unique, engaging, and different from the past titles. The `expectedStartTime` should be the current unix timestamp + (5-10 minutes in seconds).\n' +
